...
# Legend
set title "Confidence regions in the {/Symbol q}_{23}-{/Symbol D}m_{31}^2 plane"
...
set key at 0.12, 0.23 spacing 1.3    # Position and vertical spacing of legend

# Do the actual plotting
splot "th23dm31.dat" with lines lt -2 lw 2

# Show resulting EPS figure
system "evince th23dm31.eps"
