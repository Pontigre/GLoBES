...
char MYFILE3[]="th13delta_errors2x.dat";
char MYFILE4[]="deltasig_errors2x.dat";
char MYFILE5[]="th13delta_errors05x.dat";
char MYFILE6[]="deltasig_errors05x.dat";
	...
	for(this_th13=th13_lower; this_th13<=th13_upper; this_th13+=th13_step_size)
	  {
		...
		res = glbChiSys(test_values, NULL, GLB_ALL);
	...
	for(this_th13=th13_lower; this_th13<=th13_upper; this_th13+=th13_step_size)
	  {
	    ...
	    for(this_delta=delta_lower; this_delta<=delta_upper; this_delta+=delta_step_size)
	      {
		glbSetOscParams(test_values, this_th13, GLB_THETA_13);
		glbSetOscParasm(test_values, this_delta, GLB_DELTA_CP);
